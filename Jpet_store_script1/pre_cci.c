...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"1975e67dd5724e2bb26e24f1c7dd0f16\",\"statu"
...
char *random_item_id;
char *C_product_Id;
char *random_product_id;
char *random_cardType;
int randomNumber;
int think_time = 10;
...
TC_01_launch()
{
	...
	lr_end_transaction("TC_01_launch", 2);
...
lr_start_transaction("TC_02_click_store");
	...
	web_url("Catalog.action", 
		...
		"LAST");
	lr_think_time(think_time);
lr_end_transaction("TC_02_click_store", 2);
...
TC_03_click_sign_link()
{
	...
	lr_think_time(think_time);
	lr_end_transaction("TC_03_click_sigin_link", 2);
...
web_reg_save_param_ex(
	...
	web_url("Catalog.action_2", 
		...
		lr_think_time(think_time);
		lr_end_transaction("TC_05_select_pets", 2);
...
lr_start_transaction("TC_06_select_product_id");
	...
	lr_think_time(think_time);
	lr_end_transaction("TC_06_select_product_id", 2);
...
TC_07_select_item_id()
{
	...
	web_url("Catalog.action_4", 
		...
		"LAST");
	lr_think_time(think_time);
	lr_end_transaction("TC_07_select_item_id", 2);
